...
filepath=r'F:\trees_data\LC08_L1TP_175021_20200409_20200409_01_RT\LC08_L1TP_175021_20200409_20200409_01_RT_' #путь до снимка ландсат без последних двух букв названия снимка(В6)
path_shape=r'F:\trees_data\districts\seven\seven.shp' #путь до шейпа района( в названии буквы,а не цифры)
reflectance_folder = r'F:\trees_data\indexes2020' #путь до папки где лежат рефлектансы
...
# for a in range(0,intersect_width-1):
#     for b in range(0,intersect_height-1):
#         if png_arr[a + p_offset_x][b + p_offset_y][0]==0 and png_arr[a + p_offset_x][b + p_offset_y][1]==0 and  png_arr[a + p_offset_x][b + p_offset_y][2]==0:
#             tiff_arr[a + t_offset_y][b + t_offset_x] = 0
